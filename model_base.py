...
class Model(object):
    ...
    def build_train_proc(self):
        ...
        v_first_lstm_output = tf.contrib.layers.dropout(v_first_lstm_output, self.dropout_prob, is_training=self.is_training)
        ...
        v_second_attention_output, second_attention_score = layers.matrix_attention_layer(v_second_lstm_output, q_last_state, self.attention_dim, 'v_second_attention')
        ...
        self.loss_rl = tf.losses.sparse_softmax_cross_entropy(self.y, self.output,weights=self.reward) + self.regularization_beta * regularization_cost
